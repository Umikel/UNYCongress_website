...
$sql = "SELECT id, title, content, date, image FROM news";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">View News</h1>
                    ...
                    <div class="col-lg-12">
                    <div class="row">
    <?php foreach ($images as $event): ?>
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <?php if (!empty($event['image'])): ?>
                    <img src="news/<?php echo htmlspecialchars(basename($event['image'])); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($event['title']); ?>" style="width: 100%; height: 200px; object-fit: cover;">
                <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <form action="view_news.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this news?');">
    <input type="hidden" name="news_id" value="<?php echo $event['id']; ?>">
