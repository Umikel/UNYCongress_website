...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['pic']) && $_FILES['pic']['error'] == UPLOAD_ERR_OK) {
        ...
        $errors['pic'] = 'File upload error or no file selected';
    }
    ...
    if (empty($event_content)) {
        $errors['event_content'] = 'Event content is required';
    }
    if (empty($date)) {
    ...
    if (empty(array_filter($errors))) {
        $stmt = $conn->prepare("INSERT INTO events (title, content, date, venue, image) VALUES (?, ?, ?, ?, ?)");
        if ($stmt->execute([$title, $event_content, $date, $venue, $pic])) {
            $errors['general'] = 'You have successfully added the event';
            $title = $venue = $pic = $date = $event_content = "";
        } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            ?>    
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">Add event</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="add_event.php" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="Title" value="<?php echo $title ?>" placeholder="Event Title">
                            <small class="text-danger"><?php echo $errors['title'] ?></small>
                          </div>
                          <div class="form-group">
                            <label for="email">Event Content:</label>
                            <input type="text" class="form-control" id="email" value="<?php echo $event_content ?>" name="event_content" placeholder="Event Content">
                            <small class="text-danger"><?php echo $errors['event_content'] ?></small>
                        </div>
                          <div class="form-group">
                            <label for="phone">Event date:</label>
                            <input type="date" class="form-control" id="phone" value="<?php echo $date ?>" name="date" placeholder="Date of the event">
                            <small class="text-danger"><?php echo $errors['date'] ?></small>
                        </div>

                         
                          <small class="text-danger"><?php echo $errors['venue'] ?></small>
                          <div class="form-group">
                            <label for="address">Event Venue:</label>
                            <input type="text" class="form-control" id="address" name="venue" value="<?php echo $venue ?>" placeholder="Event Venue">
                            <small class="text-danger"><?php echo $errors['venue'] ?></small>
                        </div>
