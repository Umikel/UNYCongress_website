...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['pic']) && $_FILES['pic']['error'] == UPLOAD_ERR_OK) {
        $pic = 'gallery/' . basename($_FILES['pic']['name']);
    ...
    if (empty(array_filter($errors))) {
        ...
        if ($stmt->execute([$pic])) {
            $errors['general'] = 'You have successfully added the image to the galllery';
            $pic = "";
        } else {
            $errors['general'] = 'Failed to add the image into the gallery: ' . $stmt->error;
        }
    }
}
            ...
            <li class="nav-item">
                <a class="nav-link" href="view_news.php">
                    ...
                    <span>View News</span></a>
                       ...
                       <li class="nav-item">
                <a class="nav-link" href="add_gallary.php">
