        ...
        <div class="row gallery-item">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    // Dynamically display each image
                    echo '
                    <div class="col-md-4">
                        <a href="./auth/' . $row['image'] . '" class="img-pop-up">
                            <div class="single-gallery-image" style="background: url(./auth/' . $row['image'] . '); background-size: cover;"></div>
                        </a>
                    </div>';
