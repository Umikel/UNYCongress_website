...
if (isset($_GET['event_id'])) {
    ...
    $sql = "SELECT id, title, date, venue FROM events WHERE id = ?";
...
<body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="generate_pass_image.php" method="post" enctype="multipart/form-data">
    ...
    <!-- Pass Event Details (event_id) -->
    <input type="hidden" name="event_id" value="<?php echo htmlspecialchars($event['id']); ?>">
    <input type="hidden" name="event_title" value="<?php echo htmlspecialchars($event['title']); ?>">
    <input type="hidden" name="event_date" value="<?php echo htmlspecialchars($event['date']); ?>">
    <input type="hidden" name="event_venue" value="<?php echo htmlspecialchars($event['venue']); ?>">
