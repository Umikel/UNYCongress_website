...
if (isset($_GET['event_id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE events SET title = ?, content = ?, date = ?, venue = ? WHERE id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('ssssi', $title, $content, $date, $venue, $event_id);
        if ($stmt->execute()) {
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="title" value="<?php echo htmlspecialchars($event['title']); ?>" required placeholder="Event Title">
                            <small class="text-danger"><?php echo $errors['title'] ?></small>
                          </div>
                          <div class="form-group">
                            <label for="email">Event Content:</label>
                            <textarea class="form-control" id="email" required><?php echo htmlspecialchars($event['content']); ?></textarea>
                            <small class="text-danger"><?php echo $errors['event_content'] ?></small>
                        </div>
                          <div class="form-group">
                            <label for="phone">Event date:</label>
                            <input type="date" class="form-control" id="phone" value="<?php echo htmlspecialchars($event['date']); ?>" required name="date" placeholder="Date of the event">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="venue" value="<?php echo htmlspecialchars($event['venue']); ?>" required placeholder="Event Venue">
                            <small class="text-danger"><?php echo $errors['venue'] ?></small>
                        </div>
