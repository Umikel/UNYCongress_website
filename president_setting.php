...
$errors = [
    "title" => "","name" => "", "email" => "", "phone" => "", "password" => "", "pic" => "", "general" => ""];
...
if ($result1) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE president SET name = ?, email = ?, phone = ?, password = ? ";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('ssss', $name, $email, $phone, $password);
        if ($stmt->execute()) {
             // Redirect to dashboard
         header("Location: president_setting.php");
         exit;
        } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            ?>    
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">Settings</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($detail['name']); ?>" required placeholder="name">
                            <small class="text-danger"><?php echo $errors['name'] ?></small>
                          </div>
                          <div class="form-group">
                            <label for="name">Email:</label>
                            <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($detail['email']); ?>" required placeholder="Email">
                            <small class="text-danger"><?php echo $errors['email'] ?></small>
                          </div>
                          <div class="form-group">
                            <label for="phone">phone:</label>
                            <input type="text" class="form-control" id="phone" name="phone" value="<?php echo htmlspecialchars($detail['phone']); ?>" required placeholder="Event Title">
                            <small class="text-danger"><?php echo $errors['phone'] ?></small>
                          </div>
                          <div class="form-group">
                            <label for="password">password:</label>
                            <input type="text" class="form-control" id="password" name="password" value="<?php echo htmlspecialchars($detail['password']); ?>" required placeholder="Event Title">
